import { ITask, PriorityLevel } from '../models/Task';
 ...
 */
export const calculateUrgencyScore = (task: ITask, now: Date = new Date()): number => {
 ...
 */
export const sortTasksBySmartMix = (tasks: ITask[]): ITask[] => {
  const now = new Date();
